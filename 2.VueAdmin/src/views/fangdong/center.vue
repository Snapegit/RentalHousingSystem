				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="房东账号" prop="fangdongzhanghao">
							<el-input class="list_inp" v-model="user.fangdongzhanghao" readonly placeholder="房东账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="房东密码" prop="fangdongmima">
							<el-input class="list_inp" v-model="user.fangdongmima" readonly placeholder="房东密码" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="房东姓名" prop="fangdongxingming">
							<el-input class="list_inp" v-model="user.fangdongxingming"  placeholder="房东姓名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="fangdongtouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="性别" prop="xingbie">
							<el-select 
								...
								placeholder="请选择性别"
								>
								<el-option v-for="item in fangdongxingbieLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="24">
...
<script setup>
	...
	const tableName = ref('fangdong')
	const user = ref({})
	const fangdongxingbieLists = ref([])
	const init = () => {
		fangdongxingbieLists.value = "男,女".split(',')
	}
	const fangdongtouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.fangdongzhanghao)){
			context?.$toolUtil.message(`房东账号不能为空`,'error')
			return false
		}
		if((!user.value.fangdongmima)){
			context?.$toolUtil.message(`房东密码不能为空`,'error')
			return false
		}
		if((!user.value.fangdongxingming)){
			context?.$toolUtil.message(`房东姓名不能为空`,'error')
			return false
		}
