				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="房东密码" prop="fangdongmima">
							<el-input class="list_inp" v-model="form.fangdongmima" placeholder="房东密码"
								type="password" :readonly="!isAdd||disabledForm.fangdongmima?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="24">
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='fangdongmima'){
					form.value.fangdongmima = row[x];
					disabledForm.value.fangdongmima = true;
					continue;
				}
