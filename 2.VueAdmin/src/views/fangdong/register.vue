	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">房东账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.fangdongzhanghao" 
						 placeholder="请输入房东账号"
						 type="text"
						/>
				</div>
				<div class="list_item">
					<div class="list_label">房东密码：</div>
					<el-input class="list_inp"
						 v-model="registerForm.fangdongmima" 
						 placeholder="请输入房东密码"
						 type="password"
						 />
				</div>
				<div class="list_item">
					<div class="list_label">确认房东密码：</div>
					<el-input class="list_inp" v-model="registerForm.fangdongmima2" type="password" placeholder="请输入确认房东密码" />
				</div>
				<div class="list_item">
					<div class="list_label">房东姓名：</div>
					<el-input class="list_inp"
						 v-model="registerForm.fangdongxingming" 
						 placeholder="请输入房东姓名"
						 type="text"
						/>
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.fangdongzhanghao)){
			context?.$toolUtil.message(`房东账号不能为空`,'error')
			return false
		}
		if((!registerForm.value.fangdongmima)){
			context?.$toolUtil.message(`房东密码不能为空`,'error')
			return false
		}
		if((!registerForm.value.fangdongxingming)){
