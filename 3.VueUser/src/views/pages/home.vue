	...
	<div>
		<div class="home_box">
			...
			<div class="homeList_view">
				<div class="homeList_title">房源信息展示</div>
				<div class="home_list_five">
					<div v-for="(item,index) in fangyuanxinxiHomeList" :class="'home_list_five_item' + (Number(index) + 1)">
						<div class="img_box">
							<img class="home_img" v-if="isHttp(item.fangwutupian)" :src="item.fangwutupian.split(',')[0]" alt="">
							<img class="home_img" v-else :src="item.fangwutupian?$config.url + item.fangwutupian.split(',')[0]:''" alt="">
						</div>
				...
				<div class="homeList_more_view" @click="moreClick('fangyuanxinxi')">
					<span class="homeList_more_text">全部</span>
				</div>
			</div>
			<!-- 房屋资讯 -->
			<div class="newsList_view">
				<div class="newsList_title">房屋资讯</div>
...
<script setup>
	...
	//房源信息首页展示
	const fangyuanxinxiHomeList = ref([])
	const getfangyuanxinxiHomeList = () => {
		context?.$http({
			...
			fangyuanxinxiHomeList.value = res.data.data.list
		})
	}
	//房屋资讯弹窗
