	...
	<div class="app-contain" :style='{"padding":"0 12%","margin":"10px auto 20px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">房屋名称</div>
					<div  class="info_text" >{{detail.fangwumingcheng}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">租赁价格</div>
					<div  class="info_text" >{{detail.zulinjiage}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">月数</div>
					<div  class="info_text" >{{detail.yueshu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">租赁时间</div>
					<div  class="info_text" >{{detail.zulinshijian}}</div>
				</div>
				...
				<div class="info_item">
					<div class="info_label">租房合同</div>
					<div class="info_text">
						<el-button class="info_down" v-if="detail.zufanghetong" @click="downClick(detail.zufanghetong)">点击下载</el-button>
						<el-button class="info_undown" v-else>暂无</el-button>
					</div>
				</div>
				<div class="btn_view">
					<el-button class="approval_btn" v-if="btnAuth('fangwuzulin','审核')" type="warning" @click="approvalClick()">审核</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('fangwuzulin','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('fangwuzulin','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
